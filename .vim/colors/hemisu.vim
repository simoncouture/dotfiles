...
let s:lighterGrey=     { "gui": "#E4E4E4", "cterm": "254" }
...
let s:darkerGreen=     { "gui": "#5F5F00", "cterm": "28"  }
...
let s:darkerTan=       { "gui": "#870000", "cterm": "88"  }
...
if version >= 700
	...
	call s:h("MatchParen",  { "fg": s:accent1, "bg": s:lighterGrey, "gui": "bold" })
...
call s:h("Linenumbers",  { "fg": s:darkGrey, "bg": s:lighterGrey})
...
"Additions by simon:
"Set insert cursor to not be a line but to be like normal cursor
set guicursor=n-v-c-i-ci-o:block-Cursor/lCursor,ve:ver35-Cursor,r-cr:hor20-Cursor/lCursor,sm:block-Cursor-blinkwait175-blinkoff150-blinkon175